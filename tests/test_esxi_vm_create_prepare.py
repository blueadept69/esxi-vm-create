...
TEST_ARGV_PLUG_BAD_CPU_MEM_HDISK = list(TEST_ARGV_DRY_EMPTY_STORE)
TEST_ARGV_PLUG_BAD_CPU_MEM_HDISK.extend(['--cpu', '129',
                                         '--mem', '8192',
                                         '--vdisk', '65536',
                                        ])

TEST_ARGV_PLUG_BAD_DSSTORE_ISO = list(TEST_ARGV_DRY_EMPTY_STORE)
TEST_ARGV_PLUG_BAD_DSSTORE_ISO.extend(['--store', 'badstore',
...
class TestMainPrepare(TestCase):
    ...
    @patch('sys.stdout')
    @patch('sys.argv', TEST_ARGV_PLUG_BAD_CPU_MEM_HDISK)
    @patch('esxi_vm_create.SaveConfig')
    @patch('esxi_vm_create.setup_config')
    @patch('esxi_vm_create.paramiko')
    ...
    @patch('sys.stdout')
    @patch('sys.argv', TEST_ARGV_PLUG_BAD_DSSTORE_ISO)
    @patch('esxi_vm_create.SaveConfig')
    @patch('esxi_vm_create.setup_config')
    @patch('esxi_vm_create.paramiko')
